...
MICRO_REACTIONS: dict[str, list[str]] = {'low_energy': ['Lumisprout’s glow is soft and sleepy. It needs a quieter minute.', 'Lumisprout is drooping like a houseplant that heard bad news.', 'Lumisprout is conserving energy in the most woodland way possible.', 'Lumisprout looks ready to curl into a warm patch of silence.'], 'low_mood': ['Lumisprout looks dimmer than usual, like the room got quieter.', 'Lumisprout is rustling in a very small, very sad key.', 'Lumisprout could use a gentle moment before the day gets sharper.', 'Lumisprout is trying to stay bright, but the glow is thin today.'], 'low_hunger': ['Lumisprout is thinking suspiciously hard about snacks.', 'Lumisprout has begun photosynthesizing from pure hope.', 'Lumisprout is looking at the food button like it might be sunlight.', 'Lumisprout’s tiny forest ecosystem requests maintenance.'], 'low_focus': ['Lumisprout’s attention has drifted off like a loose leaf.', 'Lumisprout is listening to three different silences and none of them are useful.', 'Lumisprout is trying to focus, but the little roots are wandering.', 'Lumisprout has misplaced the thread somewhere in the moss.'], 'high_focus': ['Lumisprout is quietly focused, like a tiny forest holding its breath.', 'Lumisprout’s glow has narrowed into a very determined little beam.', 'Lumisprout is rooted in the task now.', 'Lumisprout looks calm, bright, and unusually ready.']}
