...
MICRO_REACTIONS: dict[str, list[str]] = {'low_energy': ['The pet is running on heroic amounts of stubbornness.', 'The pet looks like it needs a proper break, not another brave little shuffle.', 'The pet is trying to stand dramatically, but mostly needs rest.', 'The pet has entered low-power mode and is making it everyone’s problem.'], 'low_mood': ['The pet is having a grey little moment. Some attention would help.', 'The pet is not upset. The pet is simply deeply unimpressed with today.', 'The pet looks like the room got less friendly for a while.', 'The pet could use a small win and maybe a kind click.'], 'low_hunger': ['The pet has started developing opinions about lunch.', 'The pet is watching the concept of snacks with professional interest.', 'The pet looks polite, hungry, and one minute away from making it obvious.', 'The pet is trying not to stare at the food button.'], 'low_focus': ['The pet’s thoughts have wandered somewhere under the desk.', 'The pet is present in body. The focus has left to run errands.', 'The pet is trying to concentrate and losing by a narrow margin.', 'The pet has misplaced its tiny train of thought.'], 'high_focus': ['The pet is locked in and taking this far more seriously than expected.', 'The pet looks sharply focused, like it finally found the thread.', 'The pet is in work mode now. Tiny, intense, probably overqualified.', 'The pet has achieved a suspiciously productive stare.']}
