...
HINT_LINES: dict[str, str] = {
    **NEUTRAL_HINT_LINES,
    "recovery_hunger": "Vikamon is too hungry to pretend this is dignified.",
    "recovery_energy": "The hood has filed an official demand for silence.",
    "recovery_mood": "Vikamon is sulking with professional commitment.",
    "recovery_focus": "Vikamon misplaced her focus and is blaming the room.",
    "low_hunger": "Vikamon is approaching snack-tribute territory.",
    "low_energy": "Vikamon needs a tactical pause, obviously by choice.",
    "low_mood": "Vikamon is sulking. Carefully. With intent.",
    "low_focus": "Vikamon lost the thread and is already blaming the thread.",
    "not_fed_today": "Snack tribute would not be wasted.",
    "no_rest_today": "The hood is requesting a tactical pause.",
}
...
DAILY_ACTIVITIES: list[str] = [
    ...
    'Vikamon inspected the update situation and found it barely suspicious.',
    'Today Vikamon is supervising the workflow like a tiny hoodie tyrant.',
    'Vikamon found a harmless moment and immediately gave it legal trouble.',
    'A small success wandered by, and Vikamon acted like she arranged it.',
    'Today Vikamon is practicing the ancient art of looking in charge.',
    'Vikamon poked the routine and decided it squeaked correctly.',
    'A quiet stretch appeared, so Vikamon claimed it as monster territory.',
    'Vikamon checked the desk for crimes against competence.',
    'Today Vikamon is keeping boredom away through implied threat.',
    'Vikamon found a decent rhythm and is pretending she invented it.',
    'A normal minute survived contact with Vikamon. Historic.',
    'Today Vikamon looks ready to blame the next bug before it exists.',
]
...
IDLE_DISCOVERIES: list[str] = [
    ...
    'Vikamon has been quiet for three minutes. This is not proof of innocence.',
    'The silence gave Vikamon time to become more legally questionable.',
    'Vikamon found a calm corner and immediately lowered its property value.',
    'Nothing happened, so Vikamon started judging the concept of nothing.',
    'Vikamon prowled through the idle time and returned with a smug little huff.',
    'Silence report: Vikamon discovered one suspiciously normal moment.',
    'Vikamon used the pause to look like she knows a secret.',
    'The quiet lasted long enough for Vikamon to begin plotting against boredom.',
]



MICRO_REACTIONS: dict[str, list[str]] = {'low_energy': ['Vikamon is pretending exhaustion is a tactical choice.',
                'Vikamon looks tired, but would absolutely deny it in court.',
                'Vikamon has entered low-battery menace mode.',
                'Vikamon is saving energy for something she refuses to explain.'],
 'low_mood': ['Vikamon is visibly disappointed by the current quality of reality.',
              'Vikamon is not sulking. She is conducting an emotional audit.',
              'Vikamon looks like today failed her inspection.',
              'Vikamon could use attention, but will act like this was her plan.'],
 'low_hunger': ['Vikamon has started judging the snack situation personally.',
                'Vikamon is one missed meal away from filing a complaint.',
                'Vikamon is looking at the food button with dangerous confidence.',
                'Vikamon says the monster hood requires tribute.'],
 'low_focus': ['Vikamon’s focus has gone off to commit a minor crime.',
               'Vikamon is staring into space like space owes her money.',
               'Vikamon is trying to focus and getting distracted by her own importance.',
               'Vikamon has lost the thread and is blaming the thread.'],
 'high_focus': ['Vikamon is locked in. Unfortunately, she knows it.',
                'Vikamon has achieved dangerous levels of concentration.',
                'Vikamon is focused enough to make the desktop nervous.',
                'Vikamon looks ready to supervise the next bad idea personally.'],
 'high_energy': ['The hood reports dangerous levels of available nonsense.',
                 'Vikamon is fully charged and this should worry nearby furniture.',
                 'Vikamon has too much energy and not enough supervised chaos.',
                 'Vikamon looks ready to turn one click into a situation.'],
 'high_mood': ['Vikamon is in a suspiciously good mood. Nobody move.',
               'Vikamon seems pleased, which is either progress or a trap.',
               'Vikamon is almost cheerful and will deny this in writing.',
               'Vikamon looks happy enough to become everyone’s problem.'],
 'high_hunger': ['Vikamon has accepted the snack economy as temporarily adequate.',
                 'Snack tribute succeeded. For now.',
                 'Vikamon is full and therefore judging from a position of power.'],
 'all_good': ['Vikamon has no complaints. This is probably a trap.',
              'The hood reports acceptable conditions.',
              'Vikamon is fine, which somehow feels threatening.',
              'All systems acceptable. Vikamon remains unconvinced on principle.']}
